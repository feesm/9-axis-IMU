...
#define MEMS_INT_INT3_GPIO_Port GPIOE
#define MEMS_INT_INT3_EXTI_IRQn EXTI4_IRQn
...
#define DRDY_INT2_Pin GPIO_PIN_1
#define DRDY_INT2_GPIO_Port GPIOE
#define DRDY_INT2_EXTI_IRQn EXTI1_IRQn
